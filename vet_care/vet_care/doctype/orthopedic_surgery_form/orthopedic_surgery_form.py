...
class OrthopedicSurgeryForm(Document):
	pass
...
def get_patient_details(patient):
	...
	return {'vc_neutered': vc_neutered, 'breed':breed, 'body_wgt':body_wgt, 'gender': gender, 'color':color, 'patient_fullname':patient_name,  'microchip_number': vc_chip_id}
...
def get_customer_details(customer):
	...
	customer_fullname = customer_doc.customer_name if customer_doc.customer_name else ''
	return {"address":address, "mobile_no":mobile_no, "cpr_no":cpr_no, "email":email, "customer_fullname":customer_fullname}